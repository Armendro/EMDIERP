...
const Inventory = () => {
  ...
  const lowStockProducts = products.filter(p => (p.stock || 0) < (p.reorder_level || 0));
                      ...
                      return (
                        <tr key={product.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            ...
                            <div className="text-xs text-gray-500">Mín: {formatNumber(reorderLevel)}</div>
                          </td>
                          <td className="px-6 py-4 font-semibold text-gray-900">{formatCurrency(product.price)}</td>
                          <td className="px-6 py-4 text-gray-600">{formatCurrency(product.cost)}</td>
                          <td className="px-6 py-4">
                            {isLowStock ? (
